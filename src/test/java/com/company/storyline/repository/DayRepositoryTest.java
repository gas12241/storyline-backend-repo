...
public class DayRepositoryTest {
    ...
    public void shouldGetDayByDate() {
        ...
        Day expectedDay = dayRepository.findByDate("10230132T1293019");
        assertEquals(expectedDay.getDate(), day.getDate());
    ...
    public void shouldGetAllDays() {
        dayRepository.save(day);
        dayRepository.save(differentDay);
        assertEquals(dayRepository.findAll().size(), 2);
    }
    ...
    @Test
    public void shouldCreateDay() throws Exception {
        dayRepository.deleteAll();
        day = dayRepository.save(day);

        Optional<Day> dayFromRepo = dayRepository.findById(day.getDayId());
        assertEquals(dayFromRepo.get().getDayId(), day.getDayId());
    }
    ...
    public void shouldUpdateDay() throws Exception {
        ...
        day.setCaloriesIdle(5000);
        dayRepository.save(day);

        Optional<Day> day1 = dayRepository.findById(day.getDayId());
        assertEquals(day1.get(), day);
    }
    ...
    public void shouldDeleteDay() throws Exception {
        ...
        dayRepository.deleteById(day.getDayId());

        day1 = dayRepository.findById(day.getDayId());

        assertFalse(day1.isPresent());
    }
}